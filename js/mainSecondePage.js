...
const showBlocksSidebar = document.querySelectorAll(
  ".catalog-sidebar__filters-item-block"
);
showBlocksSidebar.forEach((block) => {
  block.addEventListener("click", () => {
    const blockSliderPrice = block
      .closest(".catalog-sidebar__filters-item")
      .querySelector(".sidebar__filters-price-slider");
    const checkboxList = block
      .closest(".catalog-sidebar__filters-item")
      .querySelector(".sidebar__checkbox-list");
    const unfoldSpan = block.querySelector(
      ".catalog-sidebar__filters-item-unfold"
    );

    if (blockSliderPrice) {
      if (
        blockSliderPrice.classList.contains(
          "sidebar__filters-price-slider__active"
        )
      ) {
        blockSliderPrice.classList.remove(
          "sidebar__filters-price-slider__active"
        );
        unfoldSpan.classList.remove(
          "catalog-sidebar__filters-item-unfold__active"
        );
      } else {
        blockSliderPrice.classList.add("sidebar__filters-price-slider__active");
        unfoldSpan.classList.add(
          "catalog-sidebar__filters-item-unfold__active"
        );
      }
    }
...
const rangeInput = document.querySelectorAll(
  ".sidebar__filters-price-slider-range input"
);
const progress = document.querySelector(
  ".sidebar__filters-price-slider-controller-progress"
);
const priceInput = document.querySelectorAll(
  ".sidebar__filters-price-slider-field input"
);
...
const unfoldArrow = document.querySelector(
  ".catalog-product__block-dropdown-unfold"
);
const modalItems = document.querySelectorAll(
  ".catalog-product__dropdown-modal-list-item"
);
...
function unfoldModalDropdown(e) {
  if (fieldDropdown) {
    ...
    unfoldArrow.classList.toggle(
      "catalog-product__block-dropdown-unfold__active"
    );
  }
}
